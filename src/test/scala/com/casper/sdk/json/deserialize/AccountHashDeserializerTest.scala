...
class AccountHashDeserializerTest extends AnyFunSuite {
  test("Deserialize AccountHash") {
    ...
    val account = JsonConverter.fromJson[AccountHash](jsonkey)
    ...
    val bytes= new AccountHash("account-hash-85148dcd6c54b77e462a9acf387fb05aca953a83011db2c601716de0af1cf47c").bytes
