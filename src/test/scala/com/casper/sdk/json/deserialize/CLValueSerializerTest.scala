...
class CLValueSerializerTest  extends AnyFunSuite {
  ...
  test("Deserialize U512 value") {
    ...
    assert(value.bytes.sameElements(HexUtils.hex2Bytes("0400ca9A3B")))
  }
  ...
  test("Deserialize PublicKey value") {
    ...
    val value = JsonConverter.fromJson[CLValue](pubKey)
    info("value is not null")
    assert(value!=null)
    ...
    assert(value.bytes.sameElements(HexUtils.hex2Bytes("017d96B9A63abCB61c870A4F55187a0a7AC24096bdB5fc585C12A686a4D892009e")))
  }
  ...
  test("Deserialize byteArray32 value") {
    val byteArray32 =""" {
                       ...
                       |                            }""".stripMargin
    val value = JsonConverter.fromJson[CLValue](byteArray32)
    info("value is not null")
    assert(value!=null)
    ...
    assert(value.bytes.sameElements(HexUtils.hex2Bytes("2fe0d35b6a92e17ee8f3ee3693452d6141df5c8db8e17a1c0985572842e13385")))
  ...
  test("Deserialize Option value") {
    val option =""" {
                  ...
                  |                                "parsed": null
                  |                            }""".stripMargin
    val value = JsonConverter.fromJson[CLValue](option)
    info("value is not null")
    assert(value!=null)
  ...
  test("Deserialize String value") {
    ...
    val value = JsonConverter.fromJson[CLValue](str)
    info("value is not null")
    assert(value!=null)
    ...
    assert(value.bytes.sameElements(HexUtils.hex2Bytes("1a00000068747470733a2f2f636173706572636f6d6d756e6974792e696f")))
