...
class SignatureDeserializerTest extends AnyFunSuite {
  test("Deserialize CLPublicKey") {
    ...
    val signature = JsonConverter.fromJson[Signature](jsonsig)
    ...
    assert(signature.bytes.sameElements(new Signature("012dbf03817a51794a8e19e0724884075e6d1fbec326b766ecfa6658b41f81290da85e23b24e88b1c8d9761185c961daee1adab0649912a6477bcd2e69bd91bd08").bytes))
  }
}