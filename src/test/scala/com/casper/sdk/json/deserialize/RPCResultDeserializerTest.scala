...
import com.casper.sdk.rpc.TestnetTester.storedVvalue
...
class RPCResultDeserializerTest  extends AnyFunSuite {
  ...
  test("RPCResultDeserializer test with getPeers") {
    ...
    val peers = JsonConverter.fromJson[RPCResult[Seq[Peer]]](peersJson).result.get
  ...
  test("RPCResultDeserializer test with getStateRootHash") {
    ...
    val stateroot_hash = JsonConverter.fromJson[RPCResult[String]](stateroothash).result.get
  ...
  test("RPCResultDeserializer test with getBlock") {
    ...
    val block = JsonConverter.fromJson[RPCResult[Block]](jsonBlock).result.get
  ...
  test("RPCResultDeserializer test with getStatus") {
    ...
    val status = JsonConverter.fromJson[RPCResult[NodeStatus]](statusJson).result.get
 ...
 val auction = JsonConverter.fromJson[RPCResult[AuctionState]](auctionInfoJson).result.get
 ...
 assert(auction.state_root_hash.toLowerCase=="836D72BC036958dF8b71dFAe04283Ff74ec5bDCa66fcA996E1f363BB9B3946a7".toLowerCase)
  ...
  test("RPCResultDeserializer test with getEraInfoBySwitchBlock") {
    ...
    val era = JsonConverter.fromJson[RPCResult[EraSummary]](eraJson).result.get
  ...
  test("RPCResultDeserializer test with getStateItem") {
    ...
    val storedValue = JsonConverter.fromJson[RPCResult[StoredValue]](storedValueJson).result.get
  ...
  test("RPCResultDeserializer test with getBalance") {
    ...
    val balance = JsonConverter.fromJson[RPCResult[String]](balanceJson).result.get
