...
class CLTypeInfoSerializerTest extends AnyFunSuite {
  ...
  test("Serialize CLTypeInfo with U64") {
    ...
    assert(CirceConverter.toJson(cLTypeInfo).get == json)
  }
