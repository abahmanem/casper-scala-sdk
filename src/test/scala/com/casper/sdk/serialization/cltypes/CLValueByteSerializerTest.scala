...
class CLValueByteSerializerTest extends AnyFunSuite {
  ...
  test("Test CLValueByteSerializer with  Option CLType ") {
    val bytes = cLValueByteSerializer.toBytes((CLValue.Option(CLValue.U32(10)).get)).get
    assert("05000000010a0000000d04" == HexUtils.toHex(bytes).get)
  }


  test("Test serialize Empty List of CLType return None ") {
    val list = CLValue.List()
    assert(list.isEmpty)
  }

  test("Test serialize non empty List of CLType ") {
    val clValue = CLValue.List(CLValue.U32(1).get, CLValue.U32(2).get, CLValue.U32(3).get).get
  ...
  test("Test CLValueBteSerializer with non empty List of CLType ") {
    val bytes = cLValueByteSerializer.toBytes(CLValue.List(CLValue.U32(1).get, CLValue.U32(2).get, CLValue.U32(3).get).get).get
    assert("10000000030000000100000002000000030000000e04" == HexUtils.toHex(bytes).get)
  }


  test("Test serialize Ok Result CLType ") {
    val clValue = CLValue.Ok(CLValue.U64(314).get, new CLTypeInfo(CLType.String)).get
    assert("013a01000000000000" == HexUtils.toHex(clValue.bytes).get)
  }

  test("Test CLValueBteSerializer with Ok Result CLType ") {
    val bytes = cLValueByteSerializer.toBytes(CLValue.Ok(CLValue.U64(314).get, new CLTypeInfo(CLType.String)).get).get
    assert("09000000013a0100000000000010050a" == HexUtils.toHex(bytes).get)
  }


  test("Test serialize Err Result CLType ") {
    val clValue = CLValue.Err(CLValue.String("Uh oh").get, new CLTypeInfo(CLType.String)).get
    assert("00050000005568206f68" == HexUtils.toHex(clValue.bytes).get)
  }

  test("Test CLValueBteSerializer with Err Result CLType ") {
    val bytes = cLValueByteSerializer.toBytes(CLValue.Err(CLValue.String("Uh oh").get, new CLTypeInfo(CLType.String)).get).get
    assert("0a00000000050000005568206f68100a0a" == HexUtils.toHex(bytes).get)
  }

  test("Test serialize Tuple1  CLType ") {
    val clValue = CLValue.Tuple1(CLValue.String("Hello, World!").get).get
    assert("0d00000048656c6c6f2c20576f726c6421" == HexUtils.toHex(clValue.bytes).get)
  }

  test("Test CLValueBteSerializer with Tuple1 CLType ") {
    val bytes = cLValueByteSerializer.toBytes(CLValue.Tuple1(CLValue.String("Hello, World!").get).get).get
    assert("110000000d00000048656c6c6f2c20576f726c642112120a" == HexUtils.toHex(bytes).get)
  }


  test("Test serialize Tuple2  CLType ") {
    val clValue = CLValue.Tuple2(CLValue.U32(1).get, CLValue.String("Hello, World!").get).get
  ...
  test("Test CLValueBteSerializer with Tuple2 CLType ") {
    val bytes = cLValueByteSerializer.toBytes(CLValue.Tuple2(CLValue.U32(1).get, CLValue.String("Hello, World!").get).get).get
  ...
  test("Test serialize Tuple3  CLType ") {
    val clValue = CLValue.Tuple3(CLValue.U32(1).get, CLValue.String("Hello, World!").get, CLValue.Bool(true).get).get
  ...
  test("Test CLValueBteSerializer with Tuple3 CLType ") {
    val bytes = cLValueByteSerializer.toBytes(CLValue.Tuple3(CLValue.U32(1).get, CLValue.String("Hello, World!").get, CLValue.Bool(true).get).get).get
  ...
  test("Test serialize ByteArray  CLType ") {
    ...
    val clValue = CLValue.ByteArray(bytes).get
