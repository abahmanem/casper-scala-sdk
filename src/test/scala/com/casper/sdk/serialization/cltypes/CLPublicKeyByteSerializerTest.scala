...
class CLPublicKeyByteSerializerTest extends AnyFunSuite {
  test("Test serialize CLPublicKey ") {
    val serializer = new CLPublicKeyByteSerializer()
    val pubkey =  CLPublicKey("01d9bf2148748a85c89da5aad8ee0b0fc2d105fd39d41a4c796536354f0ae2900c").get
    ...
    assert(serializer.toBytes(pubkey).get .sameElements(serialized))
  }
}
